...
const form = useForm({
    ...
    latitude: props.product.latitude,
    longitude: props.product.longitude,
    contact_details: props.product.contact_details,
...
const handlePhotoUpload = (event) => {
    ...
    if (photoFiles.value.length + existingPhotos.value.length + files.length > maxFiles) {
...
const setPrimaryPhoto = (index, isNew = false) => {
    if (isNew) {
        // Move the selected new photo to the front
        ...
        console.log('Set primary photo:', photo.id);
    }
};
...
const submitForm = () => {
    ...
    console.log('Raw form object data:', form.data());
...
onMounted(() => {
    ...
    console.log('Edit component mounted, initial form data:', form.data());
});
</script>
            ...
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <form @submit.prevent="submitForm" class="space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                        ...
                        <div class="p-6">
                            <!-- Existing Photos -->
                            <div v-if="existingPhotos.length > 0" class="mb-6">
                                        ...
                                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center">
                                            <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex space-x-2">
                                                <button
                                                    ...
                                                    @click="setPrimaryPhoto(index, false)"
                                                    type="button"
                                    ...
                                    >
                                        ...
                                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-200 rounded-lg flex items-center justify-center">
                                            <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex space-x-2">
                                                <button
                                                    v-if="index !== 0"
                                                    @click="setPrimaryPhoto(index, true)"
                                                    type="button"
                                                    class="px-2 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700"
                                                >
                                                    Set Primary
